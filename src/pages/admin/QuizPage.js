...
const QuizPage = () => {
  ...
  />
  <select
    className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white p-2 rounded min-w-[100px]"
    value={category}
  ...
  <select
    className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white p-2 rounded min-w-[150px]"
    value={subcategory}
  ...
  <input
    className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white p-2 rounded w-24"
