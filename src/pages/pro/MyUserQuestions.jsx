	...
	return (
		<div className="min-h-screen bg-subg-light dark:bg-subg-dark py-4 lg:py-8 px-4">
			<div className="container mx-auto">
				...
				{/* Stats Cards */}
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-6 mb-4 lg:mb-8">
					<div className="bg-white dark:bg-gray-800 rounded-xl p-2 lg:p-6 shadow-lg border border-gray-200 dark:border-gray-700">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-xl lg:text-3xl font-bold text-gray-900 dark:text-white">{stats.total}</p>
							</div>
					...
					<div className="bg-white dark:bg-gray-800 rounded-xl p-2 lg:p-6 shadow-lg border border-gray-200 dark:border-gray-700">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-xl lg:text-3xl font-bold text-yellow-600 dark:text-yellow-400">{stats.pending}</p>
							</div>
					...
					<div className="bg-white dark:bg-gray-800 rounded-xl p-2 lg:p-6 shadow-lg border border-gray-200 dark:border-gray-700">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-xl lg:text-3xl font-bold text-yellow-600 dark:text-yellow-400">{stats.approved}</p>
							</div>
							<div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-900/20 rounded-lg flex items-center justify-center">
								<span className="text-xl lg:text-2xl">✅</span>
							</div>
						...
						<div className="divide-y divide-gray-200 dark:divide-gray-700">
							{items.map((q, index) => (
								<div key={q._id} className="p-2 lg:p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors animate-fade-in" style={{animationDelay: `${index * 100}ms`}}>
									<div className="flex items-start justify-between mb-0 lg:mb-4">
