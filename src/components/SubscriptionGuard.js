...
import { hasActiveSubscription, getSubscriptionStatusTextWithTheme } from '../utils/subscriptionUtils';
    ...
    <div className="flex flex-col items-center justify-center p-8 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
      <div className="text-center">
        ...
        <div className="mt-4 text-sm text-gray-500 dark:text-gray-400">
          <p>Already have a subscription? <Link to="/subscription" className="text-blue-600 hover:underline">Check your status</Link></p>
        </div>
      </div>
    </div>
  );
