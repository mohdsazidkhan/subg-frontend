...
const RewardsDashboard = () => {
  ...
  if (error) {
    return (
      <div className="text-center p-4 sm:p-8">
        ...
        <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mb-4">{error}</p>
        <button 
  ...
  if (!rewards) {
    return (
      <div className="text-center p-4 sm:p-8">
        <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400">Failed to load rewards</p>
      </div>
    );
  }
