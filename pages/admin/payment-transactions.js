...
import AdminPaymentTransactions from '../../src/pages/admin/AdminPaymentTransactions.jsx';
import { MemoryRouter } from 'react-router-dom';

export async function getServerSideProps() { return { props: {} }; }

export default function AdminPaymentTransactionsRoute() {
  return (
    <>
      <AdminNavbar />
      <AdminMobileBottomNavigation />
      <Sidebar />
      <MemoryRouter initialEntries={["/admin/payment-transactions"]}>
